...
namespace Intersects {
    static FORCEINLINE void intersectPlaneAABBFast(const Vector &center, const Vector &extents,
                                                   const Plane &plane, const Plane &absPlane, bool &isFullyInside,
    ...
    intersectPlaneAABB(const AABB &aabb, const Plane &plane, bool &isFullyInside, bool &isPartiallyInside) {
    ...
    intersectPlaneSphereFast(const Vector &center, float radius, const Plane &plane, bool &isFullyInside,
                             bool &isPartiallyInside) {
    ...
    static FORCEINLINE bool
    intersectPlaneSphere(const Sphere &sphere, const Plane &plane, bool &isFullyInside, bool &isPartiallyInside) {
        intersectPlaneSphereFast(sphere.getCenter().toVector(1.0f), sphere.getRadius(), plane, isFullyInside,
                                 isPartiallyInside);
        return isPartiallyInside && !isFullyInside;
    }
    ...
    static FORCEINLINE bool
    intersectSphereAABBFast(const Vector &sphereCenter, const Vector &aabbMins, const Vector &aabbMaxs,
                            float radiusSq) {
        Vector result =
